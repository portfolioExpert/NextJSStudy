...
async function getStaticProps() {
  //db연결
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Cluster0:hDe1PzJfhggomi7M@cluster0.ydtpokz.mongodb.net/?retryWrites=true&w=majority"); //데이터베이스 생성
